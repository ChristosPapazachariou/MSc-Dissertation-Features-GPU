...
#define MAX_O (20)
// maximum number of scales per octave
#define MAX_S (10)
...
void GPUsift(unsigned char* img, int w, int h, char* out_filename);
...
float log2(float n);	//moved to separate file to use in both gpu and host functions
